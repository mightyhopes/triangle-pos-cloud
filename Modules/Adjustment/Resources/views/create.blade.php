...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('adjustment.add') }}</li>
    </ol>
@endsection
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('adjustments.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="note" id="note" rows="5" class="form-control" placeholder="{{ __('adjustment.note_placeholder') }}"></textarea>
                            </div>
                            <div class="mt-3">
