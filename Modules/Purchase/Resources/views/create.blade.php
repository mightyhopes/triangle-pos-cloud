...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('purchase.add') }}</li>
    </ol>
@endsection
                    ...
                    <div class="card-body">
                        ...
                        <form id="purchase-form" action="{{ route('purchases.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="note" id="note" rows="5" class="form-control" placeholder="{{ __('purchase.note_placeholder') }}"></textarea>
                            </div>
