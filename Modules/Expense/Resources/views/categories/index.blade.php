        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="categoryCreateModalLabel">{{ __('expense.create_category') }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="{{ __('expense.close') }}">
                ...
                <form action="{{ route('expense-categories.store') }}" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ __('expense.close') }}</button>
                        <button type="submit" class="btn btn-primary">{{ __('expense.create') }} <i class="bi bi-check"></i></button>
                    </div>
                </form>
            </div>
        </div>
