...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('products.add_product') }}</li>
    </ol>
@endsection
            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="barcode_symbology">{{ __('products.product_barcode_symbology') }} <span class="text-danger">*</span></label>
                                        <select class="form-control" name="product_barcode_symbology" id="barcode_symbology" required>
                                            <option value="" selected disabled>{{ __('products.select_symbology') }}</option>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_stock_alert">{{ __('products.product_stock_alert') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="product_tax_type" id="product_tax_type">
                                            ...
                                            <option value="1">{{ __('products.exclusive') }}</option>
                                            <option value="2">{{ __('products.inclusive') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="product_unit">{{ __('products.product_unit') }} <i class="bi bi-question-circle-fill text-info" data-toggle="tooltip" data-placement="top" title="{{ __('products.unit_help_text') }}"></i> <span class="text-danger">*</span></label>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="image">{{ __('products.product_images') }} <i class="bi bi-question-circle-fill text-info" data-toggle="tooltip" data-placement="top" title="{{ __('products.image_help_text') }}"></i></label>
