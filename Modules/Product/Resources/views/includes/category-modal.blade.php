    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="categoryCreateModalLabel">{{ __('products.add_category') }}</h5>
            ...
            <form action="{{ route('product-categories.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="category_code">{{ __('products.code') }} <span class="text-danger">*</span></label>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary">{{ __('products.add_category') }} <i class="bi bi-check"></i></button>
                </div>
            </form>
        </div>
    </div>
