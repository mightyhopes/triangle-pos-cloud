...
class WeeklySalesSeeder extends Seeder
{
    public function run()
    {
        ...
        // 3. Generate Random Sales for Last 7 Days
        for ($d = 0; $d < 7; $d++) {
            $date = Carbon::today()->subDays($d);
            
            // Random number of transactions per day (5 to 12)
            ...
            for ($i = 0; $i < $numTransactions; $i++) {
                ...
                $sale = Sale::create([
                    'date' => $date->copy()->addHours(rand(9, 21)), // Random time between 9 AM - 9 PM
                    'reference' => 'SALE-WEEK-' . $d . '-' . str_pad($i, 3, '0', STR_PAD_LEFT),
                    ...
                    'note' => 'Simulated Weekly Transaction'
                ]);
