...
@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        ...
        <li class="breadcrumb-item active">{{ __('purchase_return.add') }}</li>
    </ol>
@endsection
                    ...
                    <div class="card-body">
                        ...
                        <form id="purchase-return-form" action="{{ route('purchase-returns.store') }}" method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="paid_amount">{{ __('purchase_return.amount_received') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="note" id="note" rows="5" class="form-control" placeholder="{{ __('purchase_return.note_placeholder') }}"></textarea>
                            </div>
