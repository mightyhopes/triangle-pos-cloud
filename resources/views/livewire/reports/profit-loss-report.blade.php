            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small ">{{ $total_sales }} {{ __('report.sales_amount') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small">{{ $total_sale_returns }} {{ __('report.sales_return_report') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small">{{ $total_purchases }} {{ __('report.purchases_amount') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small">{{ $total_purchase_returns }} {{ __('report.purchases_return_report') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small">{{ __('expense.expenses') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small">{{ __('report.payments_received') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small">{{ __('report.payments_sent') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-3 d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="text-uppercase font-weight-bold small">{{ __('report.payments_net') }}</div>
                    </div>
                </div>
            </div>
        </div>
